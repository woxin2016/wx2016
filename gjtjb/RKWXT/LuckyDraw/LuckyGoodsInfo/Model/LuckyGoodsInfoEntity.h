...
typedef enum{
    LuckyGoods_Postage_Have = 0,   //不包邮
    LuckyGoods_Postage_None,       //包邮
}LuckyGoods_Postage;

@interface LuckyGoodsInfoEntity : NSObject
//商品基本介绍
...
@property (nonatomic,assign) LuckyGoods_Postage postage;   //邮费
...
+(LuckyGoodsInfoEntity*)goodsInfoEntityWithBaseDic:(NSDictionary*)baseDic withStockDic:(NSDictionary*)stockDic;
