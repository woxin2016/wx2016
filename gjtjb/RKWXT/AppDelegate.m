...
//        [_loginModel loginWithUser:userDefault.user andPwd:userDefault.pwd];
        ...
        NSSet *set2 = [[NSSet alloc] initWithObjects:[NSString stringWithFormat:@"%@",userDefault.user], [NSString stringWithFormat:@"seller_%@",userDefault.sellerID], nil];
        
//        [APService setTags:[NSSet setWithObject:[NSString stringWithFormat:@"%@ seller_%@",userDefault.user,userDefault.sellerID]] alias:nil callbackSelector:nil object:nil];
        
        [APService setTags:set2 alias:nil callbackSelector:nil object:nil];
