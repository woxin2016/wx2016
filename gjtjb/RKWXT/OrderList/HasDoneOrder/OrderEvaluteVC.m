...
@interface OrderEvaluteVC()<UITableViewDataSource,UITableViewDelegate,EvaluteGoodsCellDelegate,OrderEvaluateModelDelegate,EvaluteUserHandleCellDelegate>{
    UITableView *_tableView;
    AllOrderListEntity *entity;
    OrderEvaluateModel *_model;
...
@implementation OrderEvaluteVC

-(id)init{
    self = [super init];
    if(self){
        _model = [[OrderEvaluateModel alloc] init];
