...
-(void)headerRefreshing{
    ...
    if([monthCTArr count] == 0){
        ...
        [_model loadUserCloudTicketData:0 length:[monthCTArr count] days:LoadDaysType];
    }
}

-(void)footerRefreshing{
    isRefresh = NO;
    [_model loadUserCloudTicketData:[monthCTArr count] length:EveryTimeLoad days:LoadDaysType];
}
