...
-(void)headerRefreshing{
    isRefresh = YES;
    if([allCTArr count] == 0){
        [_model loadUserCloudTicketData:0 length:EveryTimeLoad type:UserCloudTicket_Type_All];
    }else{
        [_model loadUserCloudTicketData:0 length:[allCTArr count] type:UserCloudTicket_Type_All];
    }
}

-(void)footerRefreshing{
    isRefresh = NO;
    [_model loadUserCloudTicketData:[allCTArr count] length:EveryTimeLoad type:UserCloudTicket_Type_All];
}
